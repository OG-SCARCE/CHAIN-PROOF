...
const float PI_OVER_6 = 0.52359877;
const uint M1 = 1597334677U;
const uint M2 = 3812015801U;
const uint M3 = 3192451361U;
...
export default function PixelSnow({
  ...
  return <div ref={containerRef} className={`w-full h-full ${className}`} style={{ minHeight: '100%', willChange: 'transform', ...style }} />;
}
